  ...
  return (
    <div className="min-h-svh bg-[#4ADE80] flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden" 
      ...
      <div className="text-center mb-8 relative z-10">
        <h1 className="font-brand text-[44px] text-white tracking-normal leading-none drop-shadow-sm">Changuito</h1>

      </div>

      {/* Main Card */}
      <div className="w-full max-w-[380px] bg-white rounded-[28px] shadow-2xl p-8 relative z-10">
        <h2 className="text-[22px] font-bold text-stone-800 tracking-tight">Iniciar Sesión</h2>
        <p className="text-stone-500 text-[13px] mt-1 mb-6">Bienvenido de vuelta.</p>

        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          {/* Email Field */}
          <div>
            <label htmlFor="email" className="text-[11px] font-bold text-stone-500 uppercase tracking-widest block mb-1.5 ml-1">Email</label>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5 ml-1 mr-1">
              <label htmlFor="password" className="text-[11px] font-bold text-stone-500 uppercase tracking-widest">Contraseña</label>
